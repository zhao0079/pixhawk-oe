...
# TODO Added glibc dependency, seemed to be necessary. 

DEPENDS = "virtual/kernel perl-native glibc"
...
# Set ti tools dir only if not previously set (e.g. by user profile)
# Set codec engine file location based on tools dir 

# Set $TITOOLS in your build profile file (e.g. /oe/build/profile) to change the default tools directory 

# Order matters! leave CEFILES above TITOOLSDIR!
CEFILES = "${@base_conditional('TITOOLS', '', 'http://copy.in.source.dir/codec_engine_2_23_01.tar.gz', 'file://${TITOOLS}/codec_engine_2_23_01.tar.gz', d)}"
TITOOLSDIR = "${@base_conditional('TITOOLS', '', '/OE/TI', '${TITOOLS}', d)}"


# TODO: Remove after validation of recipe

#TITOOLSDIR ?= "${OE_HOME}/ti"
#CEFILES = "file://${TITOOLSDIR}/codec_engine_2_23_01.tar.gz"
#CEFILES = "http://copy.in.source.dir/codec_engine_2_23_01.tar.gz"
...
TIBIOSDIR ?= "${TITOOLSDIR}/bios_5_33_03"
TIXDCTOOLSDIR ?= "${TITOOLSDIR}/xdctools_3_15_00_50"
TICGTOOLSDIR ?= "${TITOOLSDIR}/cg6x_6_0_17"
...
CEEXAMPLESDEVICES_overo = "OMAP3530"
